	...
	return (
		<DropdownMenuPrimitive.Portal>
			<DropdownMenuPrimitive.Content
				class={cn(
					"z-50 min-w-32 origin-(--kb-menu-content-transform-origin) animate-content-hide overflow-hidden rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-md data-expanded:animate-content-show",
					props.class
				)}
				{...rest}
			/>
